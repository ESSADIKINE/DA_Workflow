...
<body>
    <div class="container">
        <div class="Main">
            ...
            <p>Veuillez entrer ce code pour vérifier votre adresse email. Ce code est valide pendant 10 minutes.</p>
            <a href="https://dstm.website" target="_blank" class="button">Visiter notre site</a>
        </div>
        <div class="contact-info">
            <img class="img" src="https://dstm.website/wp-content/uploads/2024/07/unnamed.png" alt="Company Location">
            <p>
